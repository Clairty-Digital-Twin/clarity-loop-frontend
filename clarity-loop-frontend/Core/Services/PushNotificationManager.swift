...
struct NotificationPreferences: Codable {
    ...
    var insightNotifications: InsightNotificationPreferences = InsightNotificationPreferences()
    var healthAlerts: HealthAlertPreferences = HealthAlertPreferences()
    var patReminders: PATReminderPreferences = PATReminderPreferences()
}

struct InsightNotificationPreferences: Codable {
    var enabled: Bool = true
    var onlyHighPriority: Bool = false
    var categories: Set<String> = []
}

struct HealthAlertPreferences: Codable {
    var enabled: Bool = true
    var thresholdAlerts: Bool = true
    var trendAlerts: Bool = true
    var anomalyAlerts: Bool = true
}
